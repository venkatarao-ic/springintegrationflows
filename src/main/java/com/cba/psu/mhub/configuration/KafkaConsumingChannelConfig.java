package com.cba.psu.mhub.configuration;
...
import com.cba.psu.mhub.service.CountDownLatchHandler;
...
@Configuration
public class KafkaConsumingChannelConfig {
    ...
    public ConcurrentMessageListenerContainer<String, String> kafkaListenerContainer() {
        ContainerProperties containerProps = new ContainerProperties(kafkaPaymentOut);
